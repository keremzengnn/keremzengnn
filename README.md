...
Çıktı: `rapor.html` (Siemens renkleri, yazdırılabilir), `rapor.md`, `rapor.json`.
...
Pencerede: **Klasör…** veya **Zip…** ile backup'ı seçin → **Analizi başlat** → rapor tarayıcıda açılır.

Komut satırı:
```
python -m pcs7_analyzer D:\Backup\Proje.zip -o D:\Raporlar\Proje --open
